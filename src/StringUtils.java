public class StringUtils {
    ...
    public static String makePurdueUsername(String firstName, String lastName) {
         ...
         */
        String res;
        if((firstName.substring(0,1) + lastName).length() > 8) {
            res = (firstName.substring(0, 1) + lastName).substring(0, 8).toLowerCase();
        }
        else {
            res = (firstName.substring(0, 1) + lastName).toLowerCase();
        }
